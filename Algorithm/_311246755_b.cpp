...
//Constructor
_311246755_b::MazeCell::MazeCell() : numOfDirsTried(0), obstacle(MazeObstacle::UNKNOWN) {
	for (int i = 0; i < 4; i++) {
...
//Constructor
_311246755_b::_311246755_b() : mappedMaze(), isWidthKnown(false), isHeightKnown(false), placedBookmark(false), directionChosen(false) {
	//set seed for random
	srand((int)time(NULL));
 ...
 */
void _311246755_b::updateLocation(const Move dir) {
 ...
 */
void _311246755_b::updateTriedFromOrigin(MazeCell &cell) {
